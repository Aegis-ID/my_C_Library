...
int ll_convert_o(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = convert_base(va_arg(ap, long long unsigned int), 8, precision);
...
int ll_convert_x(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = convert_base(va_arg
        (ap, long long unsigned int), 16, precision);
    int str_len = my_strlen(str);
...
int ll_convert_x_upcase(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = my_strupcase(convert_base(va_arg
        (ap, long long unsigned int), 16, p));
    int str_len = my_strlen(str);
...
int ll_convert_u(va_list ap, int len, char **flag)
{
    ...
    int format = 0;
    char *str = convert_base(va_arg
        (ap, long long unsigned int), 10, precision);
    int str_len = my_strlen(str);
