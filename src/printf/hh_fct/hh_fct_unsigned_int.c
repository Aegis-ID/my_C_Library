...
int hh_convert_o(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = convert_base((unsigned char)va_arg(ap, int), 8, precision);
...
int hh_convert_x(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = convert_base((unsigned char)va_arg(ap, int), 16, precision);
    int str_len = my_strlen(str);
...
int hh_convert_x_upcase(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = my_strupcase(convert_base((unsigned char)va_arg
        (ap, int), 16, p));
    int str_len = my_strlen(str);
...
int hh_convert_u(va_list ap, int len, char **flag)
{
    ...
    char add;
    int format = 0;
    char *str = convert_base((unsigned char)va_arg(ap, int), 10, precision);
    int str_len = my_strlen(str);
